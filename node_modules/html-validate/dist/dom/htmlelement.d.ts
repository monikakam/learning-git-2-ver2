...
export declare class HtmlElement extends DOMNode {
    ...
    private metaElement;
    private annotation;
    constructor(tagName: string, parent?: HtmlElement | null, closed?: NodeClosed, meta?: MetaElement | null, location?: Location | null);
    static rootNode(location: Location | null): HtmlElement;
